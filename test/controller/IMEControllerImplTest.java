...
/**
 * Test class to test functionality of the controller, command through inputs given as text
 * commands.
 */
public class IMEControllerImplTest {
  ...
  @Test
  public void testLoadBMPAndSavePNGImage() throws Exception {
    StringBuffer out = new StringBuffer();
    Reader in = new StringReader("load input/ms.bmp ms\n" +
        "save output/ms.png ms");
    controller = new IMEControllerImpl(in, out);
  ...
  @Test
  public void testLoadBMPAndSaveJPGImage() throws Exception {
    StringBuffer out = new StringBuffer();
    Reader in = new StringReader("load input/ms.bmp ms\n" +
        "save output/ms.jpg ms");
    controller = new IMEControllerImpl(in, out);
  ...
  @Test
  public void testLoadBMPAndSaveJPEGImage() throws Exception {
    StringBuffer out = new StringBuffer();
    Reader in = new StringReader("load input/ms.bmp ms\n" +
        "save output/ms.jpeg ms");
    controller = new IMEControllerImpl(in, out);
  ...
  @Test
  public void testImageSharpenTwice() throws Exception {
    StringBuffer out = new StringBuffer();
    Reader in = new StringReader("load input/ms.png ms\n" +
        "sharpen ms mss\n" +
        "sharpen mss msss\n" +
