...
/**
 * This class is used to perform the operation of loading and processing image files of bmp format.
 */
public class LoadBMP extends AbstractLoadImage {

  /**
   * This method is used to load a bmp image file located at the given path.
   *
