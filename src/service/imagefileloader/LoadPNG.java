...
/**
 * This class is used to perform the operation of loading and processing image files of png format.
 */
public class LoadPNG extends AbstractLoadImage {

  /**
   * This method is used to load a png image file located at the given path.
   *
