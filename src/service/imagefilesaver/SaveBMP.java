...
/**
 * This class is used to perform the operation of saving the manipulated image files in bmp format.
 */
public class SaveBMP extends AbstractSaveImage {

  /**
   * This method is used to save the manipulated image file at the given path with bmp format.
   *
